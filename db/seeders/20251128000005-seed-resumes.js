...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const locations = [
      'Москва', 'Москва', 'Москва', 'Москва', 'Москва', // Больше кандидатов в Москве
      ...
      'Томск', 'Оренбург', 'Кемерово', 'Рязань', 'Пенза',
      'Калининград', 'Курск', 'Сочи', 'Тверь', 'Брянск',
      'Белгород', 'Сургут', 'Владимир', 'Архангельск', 'Мурманск',
      'Удаленно', 'Удаленно'
    ];
